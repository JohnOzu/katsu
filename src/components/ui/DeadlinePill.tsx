...
export default function DeadlinePill({ deadline }: { deadline: string | null }) {
    ...
    return (
        <div className={`inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-lg text-xs font-medium border w-fit ${dl?.color ?? 'text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-700/50 border-slate-200 dark:border-slate-600'}`}>
