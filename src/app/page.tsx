...
export default function HomePage() {
	...
	// Don't render auth-dependent UI until store is hydrated
	// This prevents the guest flash on initial load
	if (!hydrated) {
		return (
		...
		<div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50">
				...
				<div className="max-w-7xl mx-auto px-6 py-6">
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center space-x-6">
							<Link href="#features" className="text-slate-700 hover:text-blue-600 font-medium transition-colors cursor-pointer">
								Features
							</Link>
							<Link href="#how-it-works" className="text-slate-700 hover:text-blue-600 font-medium transition-colors cursor-pointer">
								How It Works
							</Link>
							...
							{user ? (
								<div className="relative" ref={dropdownRef}>
									<button
										...
										className="flex items-center space-x-2.5 px-3 py-2 rounded-xl hover:bg-slate-100 transition-colors cursor-pointer"
									>
										...
										<span className="text-slate-700 font-medium text-sm">{user.user_metadata.name}</span>
										<svg
									...
									{dropdownOpen && (
										<div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-xl shadow-slate-200/80 border border-slate-100 overflow-hidden z-50">
											<div className="px-4 py-3 border-b border-slate-100">
												<p className="text-sm font-semibold text-slate-900">{user.user_metadata.name}</p>
												<p className="text-xs text-slate-400 truncate">{user.email}</p>
											</div>
											<Link
												href="/dashboard"
												className="cursor-pointer flex items-center space-x-2.5 px-4 py-3 text-sm text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
											>
											...
											<button
												...
												className="w-full flex items-center space-x-2.5 px-4 py-3 text-sm text-red-500 hover:bg-red-50 transition-colors cursor-pointer"
											>
												<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								...
								<>
									<Link href="/login" className="px-5 py-2.5 text-slate-700 hover:text-blue-600 font-medium transition-colors cursor-pointer">
										Log In
									</Link>
				...
				<div className="text-center animate-fadeInUp">
					...
					<div className="flex items-center justify-center space-x-4">
						{user ? (
							<Link
								href="/dashboard"
								className="cursor-pointer group px-8 py-4 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-blue-500/40 transition-all transform hover:-translate-y-1 inline-flex items-center"
							>
								Go to Dashboard
			...
			<section id="features" className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
				<div className="text-center mb-16">
					<h2 className="text-5xl font-black text-slate-900 mb-4">Everything for Tracking Needs</h2>
					<p className="text-xl text-slate-600">Purpose-built features for academic collaboration and task tracking</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-8">
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Organize students by class year and program. Every member sees shared tasks and deadlines in real-time.</p>
					</div>
					...
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Separate tasks by subject. See all Computer Science, Math, and English assignments at a glance.</p>
					</div>
					...
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Never miss a deadline. Get notifications for upcoming tasks and keep your entire class on schedule.</p>
					</div>
					...
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Track individual and class-wide progress. See completion rates and stay motivated together.</p>
					</div>
					...
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Visualize all deadlines in a unified calendar. Plan your study schedule effectively.</p>
					</div>
					...
					<div className="group p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100">
						...
						<p className="text-slate-600 leading-relaxed">Class data stays within your group. Secure authentication and role-based access control.</p>
					</div>
				</div>
			</section>
			...
			<section id="how-it-works" className="relative z-10 max-w-7xl mx-auto px-6 py-20">
				<div className="text-center mb-16">
					<h2 className="text-5xl font-black text-slate-900 mb-4">Get Started in Minutes</h2>
					<p className="text-xl text-slate-600">Simple setup, powerful results</p>
				</div>

				<div className="grid md:grid-cols-4 gap-6">
					<div className="text-center">
						<div className="w-16 h-16 bg-linear-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black text-blue-600">1</div>
					...
					<div className="text-center">
						<div className="w-16 h-16 bg-linear-to-br from-indigo-100 to-indigo-200 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black text-indigo-600">2</div>
					...
					<div className="text-center">
						<div className="w-16 h-16 bg-linear-to-br from-purple-100 to-purple-200 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black text-purple-600">3</div>
					...
					<div className="text-center">
						<div className="w-16 h-16 bg-linear-to-br from-pink-100 to-pink-200 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black text-pink-600">4</div>
			...
			<section className="relative z-10 max-w-5xl mx-auto px-6 py-20 mb-10">
				<div className="bg-linear-to-br from-blue-600 to-indigo-700 rounded-3xl p-12 text-center shadow-2xl shadow-blue-500/30">
					<h2 className="text-4xl md:text-5xl font-black text-white mb-4">Ready to Organize Your Class?</h2>
					<p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
						Stop missing deadlines. Start owning your semester.
					</p>
					{user ? (
						<Link href="/dashboard" className="cursor-pointer inline-block px-10 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
							Go to Your Dashboard
						</Link>
					) : (
						<Link href="/login" className="cursor-pointer inline-block px-10 py-4 bg-white text-blue-600 rounded-2xl font-bold text-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
				...
				<div className="max-w-7xl mx-auto px-6 py-12">
					<div className="grid md:grid-cols-4 gap-8">
						<div>
							...
							<p className="text-slate-600 text-sm">Empowering students to stay organized and succeed together.</p>
						</div>
						<div>
