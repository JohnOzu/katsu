		...
		<div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900">
			...
			<section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
				<div className="text-center animate-fadeInUp">
					...
					{/* Trust Indicators */}
					<div className="mt-16">
						<div className="inline-flex items-center space-x-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm px-8 py-4 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700">
			...
			<section id="features" className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
				<div className="text-center mb-16">
					<h2 className="text-5xl font-black text-slate-900 dark:text-white mb-4">Everything for Tracking Needs</h2>
					<p className="text-xl text-slate-600 dark:text-slate-400">Purpose-built features for academic collaboration and task tracking</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-8">
					{[
						...
						<div key={feature.title} className="group p-8 bg-white dark:bg-slate-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 border border-slate-100 dark:border-slate-700">
			...
			<section id="how-it-works" className="relative z-10 max-w-7xl mx-auto px-6 py-20">
				<div className="text-center mb-16">
					<h2 className="text-5xl font-black text-slate-900 dark:text-white mb-4">Get Started in Minutes</h2>
					<p className="text-xl text-slate-600 dark:text-slate-400">Simple setup, powerful results</p>
				</div>
				...
				<div className="grid md:grid-cols-4 gap-6">
					{[
						...
						<div key={step.num} className="text-center">
							<div className={`w-16 h-16 bg-linear-to-br ${step.gradient} dark:bg-none dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black ${step.textColor}`}>{step.num}</div>
