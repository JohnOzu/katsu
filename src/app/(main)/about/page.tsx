	...
	return (
		<div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900">
			<div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
				...
				<div className="bg-white dark:bg-slate-800 rounded-3xl shadow-lg border border-slate-100 dark:border-slate-700 p-7 sm:p-10 mb-8">
					<h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mb-4">Our Mission</h2>
				...
				<div className="bg-linear-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 sm:p-10 text-center text-white">
					<h2 className="text-2xl sm:text-3xl font-black mb-4">A Small Team with Big Ambitions</h2>
					<p className="text-blue-100 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-6">
